...
def promoteQA () {
	...
	openshiftDeploy(depCfg: 'app-qa', namespace: 'erickalmeida', verbose: 'false', waitTime: '10', waitUnit: 'min')
...
def promotePROD () {
	...
	openshiftDeploy(depCfg: 'app-prod', namespace: 'erickalmeida', verbose: 'false', waitTime: '10', waitUnit: 'min')
